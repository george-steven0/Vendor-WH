import classes from '../../assets/styles/binLocationProducts.module.css'
            ...
            <section className={classes.icc}>
                <div className={classes.topheader}>
                    ...
                    <div className={classes.title}>
                        <span>Lists of products in Bin Location</span>
                    </div>
                ...
                <div className={classes.orderDetails}>
                    ...
                    <div className={classes.orderCards}>
                        <OrderCard iccScanLoading = {true} scan={true}  />
                        <OrderCard iccScanLoading = {true}  scan={true} />
                        <OrderCard iccScanLoading = {true}  scan={true} />
                        <OrderCard iccScanLoading = {true}  scan={true} />
                        <OrderCard iccScanLoading = {true}  scan={true} />
...
export default ProductsBinLocation;